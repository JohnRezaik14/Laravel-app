...
<body>
    @section('navbar')
        <nav
            ...
            <a class=" bg-gray-300 rounded-lg my-1 p-1 hover:bg-blue-200  " href="/">Home</a>
            <a class=" bg-gray-300 rounded-lg my-1 p-1 hover:bg-blue-200  " href="{{ route('posts.index') }}">Posts</a>
